        ...
        $(document).ready(function(){
            ...
            var dataTable = $('#datos_usuario').DataTable({
                ...
                $(document).on('click', '.borrar', function(){
                    var id_usuario = $(this).attr("id");//al dar clic se optien el  id del usuario
                    if(confirm("Esta seguro de borrar este registro:" + id_usuario))//pregunta si esta seguro y concatena el id
                    {
                        $.ajax({//empieza el envio por ajax para borrar
                            url:"borrar.php",
                            method:"POST",//usa el metodo post
                            data:{id_usuario:id_usuario},
                            success:function(data)//si es correcto continua y manda una alerta
                            {
                                alert(data);
                                dataTable.ajax.reload();
                            }
